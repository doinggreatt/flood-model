...
df = pd.read_excel('datasets/11143.xlsx')
...
features.fillna(features.mean(), inplace=True) # saving from NaN meanings 
...
val_loss = model.evaluate(val_data, steps=20)

print('Raw data MSE:', mse)
print('MSE:', val_loss)
model.save('models/model-11143.h5')